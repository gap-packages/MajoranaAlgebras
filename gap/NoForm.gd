...
#! @Chapter Majorana representations with no inner product
...
#! @ChapterInfo Majorana representations with no inner product, The main function
...
#! the existence of a Frobenius form on the algebra.
#! @ChapterInfo Majorana representations with no inner product, The n-closed function

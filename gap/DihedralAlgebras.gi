...
rec(    algebraproducts := [    SparseMatrix( 1, 3, [ [ 1 ] ], [ [ 1 ] ] ), 
        ...
        evecs := [  [   SparseMatrix( 1, 3, [ [ 1, 2, 3 ] ], [ [ -1/4, 1, 1 ] ] ), 
                        SparseMatrix( 1, 3, [ [ 2, 3 ] ], [ [ -1, 1 ] ] ), 
                        SparseMatrix( 0, 3, [  ], [  ] ) ], 
                    [   SparseMatrix( 1, 3, [ [ 1, 2, 3 ] ], [ [ 1, -1/4, 1 ] ] ), 
                        SparseMatrix( 1, 3, [ [ 1, 3 ] ], [ [ -1, 1 ] ] ), 
                        SparseMatrix( 0, 3, [  ], [  ] ) ], 
                    [   SparseMatrix( 1, 3, [ [ 1, 2, 3 ] ], [ [ -4, -4, 1 ] ] ), 
                        SparseMatrix( 1, 3, [ [ 1, 2 ] ], [ [ -1, 1 ] ] ), 
                        SparseMatrix( 0, 3, [  ], [  ] ) ] ],
        group := g,
        innerproducts := [ 1, 1/8, 1/8, 1, 1/8, 1 ],
        involutions := [ g.1, g.2, g.1*g.2 ],
        nullspace := SparseMatrix( 0, 3, [  ], [  ] ),
        setup := rec(   conjelts := [ [ 1 .. 3 ] ],
                        coords := [ g.1, g.2, g.1*g.2 ],
                        longcoords := [ g.1, g.2, g.1*g.2 ],
...
rec(     algebraproducts := [   SparseMatrix( 1, 2, [ [ 1 ] ], [ [ 1 ] ] ), 
                                SparseMatrix( 1, 2, [ [  ] ], [ [  ] ] ), 
                                SparseMatrix( 1, 2, [ [ 2 ] ], [ [ 1 ] ] ) ],
        evecs := [  [   SparseMatrix( 1, 2, [ [ 2 ] ], [ [ 1 ] ] ), 
                        SparseMatrix( 0, 2, [  ], [  ] ), 
                        SparseMatrix( 0, 2, [  ], [  ] ) ], 
                    [   SparseMatrix( 1, 2, [ [ 1 ] ], [ [ 1 ] ] ), 
                        SparseMatrix( 0, 2, [  ], [  ] ), 
                        SparseMatrix( 0, 2, [  ], [  ] ) ] ],
        group := g,
        innerproducts := [ 1, 0, 1 ],
        involutions := [ g.1, g.2 ],
        nullspace := SparseMatrix( 0, 2, [  ], [  ] ),
        setup := rec(   conjelts := [ [ 1 .. 2 ] ],
                        coords := [ g.1, g.2 ],
                        longcoords := [ g.1, g.2 ],
                        orbitreps := [ 1, 2 ],
                        nullspace := rec(   vectors := SparseMatrix( 0, 2, [  ], [  ] ),
                                            heads := [] ),
                        pairconj := [ [ 1, 1 ], [ 1, 1 ] ],
...
rec(    algebraproducts := [    SparseMatrix( 1, 4, [ [ 1 ] ], [ [ 1 ] ] ), 
        ...
        evecs := [  [   SparseMatrix( 1, 4, [ [ 1, 2, 3, 4 ] ], [ [ -10/27, 32/27, 32/27, 1 ] ] ), 
                        SparseMatrix( 1, 4, [ [ 1, 2, 3, 4 ] ], [ [ -8/45, -32/45, -32/45, 1 ] ] ), 
                        SparseMatrix( 1, 4, [ [ 2, 3 ] ], [ [ -1, 1 ] ] ) ], 
                    [ false, false, false ], 
                    [ false, false, false ] ],
        group := g,
        ...
        setup := rec(   conjelts := [ [ 1 .. 4 ], [ 2, 3, 1, 4 ], [ 3, 2, 1, 4 ] ],
                        coords := [ g.1, g.2, g.1*g.2*g.1, g.1*g.2 ],
                        longcoords := [ g.1, g.2, g.1*g.2*g.1, g.1*g.2, g.2*g.1 ],
                        orbitreps := [ 1 ],
                        nullspace := rec(   vectors := SparseMatrix( 0, 4, [  ], [  ] ),
                                            heads := [] ),
...
rec (   algebraproducts := [    SparseMatrix( 1, 3, [ [ 1 ] ], [ [ 1 ] ] ), 
        ...
        evecs := [  [   SparseMatrix( 1, 3, [ [ 1, 2, 3 ] ], [ [ -1/32, 1, 1 ] ] ), 
                        SparseMatrix( 0, 3, [  ], [  ] ), 
                        SparseMatrix( 1, 3, [ [ 2, 3 ] ], [ [ -1, 1 ] ] ) ], 
...
rec (   algebraproducts := [    SparseMatrix( 1, 5, [ [ 1 ] ], [ [ 1 ] ] ), 
        ...
        evecs := [  [   SparseMatrix( 2, 5, [ [ 1, 2, 4, 5 ], [ 3 ] ], [ [ -1/2, 2, 2, 1 ], [ 1 ] ] ), 
                        SparseMatrix( 1, 5, [ [ 1, 2, 3, 4, 5 ] ], [ [ -1/3, -2/3, -1/3, -2/3, 1 ] ] ), 
                        SparseMatrix( 1, 5, [ [ 2, 4 ] ], [ [ -1, 1 ] ] ) ], 
                    [   SparseMatrix( 2, 5, [ [ 1, 2, 3, 5 ], [ 4 ] ], [ [ 2, -1/2, 2, 1 ], [ 1 ] ] ), 
                        SparseMatrix( 1, 5, [ [ 1, 2, 3, 4, 5 ] ], [ [ -2/3, -1/3, -2/3, -1/3, 1 ] ] ), 
                        SparseMatrix( 1, 5, [ [ 1, 3 ] ], [ [ -1, 1 ] ] ) ], 
                    [ false, false, false ], [ false, false, false ] ],
        group := g,
        innerproducts := [ 1, 1/32, 0, 1, 0, 3/8, 3/8, 2 ],
        involutions := [g.1, g.2, g.2*g.1*g.2, g.1*g.2*g.1],
        nullspace := SparseMatrix( 0, 5, [  ], [  ] ),
        setup := rec(   conjelts := [ [ 1 .. 5 ], [ 3, 2, 1, 4, 5 ], [ 1, 4, 3, 2, 5 ] ],
                        coords := [g.1, g.2, g.2*g.1*g.2, g.1*g.2*g.1, g.1*g.2],
                        longcoords := [g.1, g.2, g.2*g.1*g.2, g.1*g.2*g.1, g.1*g.2, g.2*g.1],
                        orbitreps := [ 1, 2 ],
...
rec (   algebraproducts := [    SparseMatrix( 1, 5, [ [ 1 ] ], [ [ 1 ] ] ), 
                                ...
                                SparseMatrix( 1, 5, [ [ 2, 4, 5 ] ], [ [ 1/8, -1/8, 1/8 ] ] ), 
                                SparseMatrix( 1, 5, [ [ 5 ] ], [ [ 1 ] ] ) ],
        evecs :=  [ [   SparseMatrix( 2, 5, [ [ 1, 3, 5 ], [ 1, 2, 3, 4 ] ], [ [ -1/4, 1, 1 ], [ -1/16, 1, 1/4, 1 ] ] ), 
                        SparseMatrix( 1, 5, [ [ 3, 5 ] ], [ [ -1, 1 ] ] ), 
                        SparseMatrix( 1, 5, [ [ 2, 4 ] ], [ [ -1, 1 ] ] ) ], 
                    [   SparseMatrix( 2, 5, [ [ 1, 3, 5 ], [ 1, 2, 3, 4 ] ], [ [ -4, -4, 1 ], [ 4, -1/4, 4, 1 ] ] ), 
                        SparseMatrix( 1, 5, [ [ 4, 5 ] ], [ [ -1, 1 ] ] ), 
                        SparseMatrix( 1, 5, [ [ 1, 3 ] ], [ [ -1, 1 ] ] ) ], 
                    [ false, false, false ], [ false, false, false ], 
                    [   SparseMatrix( 2, 5, [ [ 1, 3, 5 ], [ 1, 2, 3, 4 ] ], [ [ -4, -4, 1 ], [ -1, 1, -1, 1 ] ] ), 
                        SparseMatrix( 2, 5, [ [ 2, 4 ], [ 1, 3 ] ], [ [ -1, 1 ], [ -1, 1 ] ] ), SparseMatrix( 0, 5, [  ], [  ] ) ] ],
        group := g,
        innerproducts := [ 1, 1/64, 1/8, 1/8, 1, 1/8, 1/8, 1 ],
        involutions := [g.1, g.2, g.2*g.1*g.2, g.1*g.2*g.1, (g.1*g.2)^2],
        nullspace := SparseMatrix( 0, 5, [  ], [  ] ),
        setup := rec(   conjelts := [ [ 1 .. 5 ], [ 3, 2, 1, 4, 5 ], [ 1, 4, 3, 2, 5 ] ],
                        coords := [g.1, g.2, g.2*g.1*g.2, g.1*g.2*g.1, (g.1*g.2)^2],
                      longcoords := [g.1, g.2, g.2*g.1*g.2, g.1*g.2*g.1, (g.1*g.2)^2],
                      orbitreps := [ 1, 2, 5 ],
...
rec(    algebraproducts := [    SparseMatrix( 1, 6, [ [ 1 ] ], [ [ 1 ] ] ), 
        ...
        evecs := [  [   SparseMatrix( 2, 6, [ [ 1, 2, 3, 6 ], [ 1, 2, 3, 4, 5 ] ], [ [ 21/4096, -7/64, -7/64, 1 ], [ -3/32, 1, 1, 1, 1 ] ] ), 
                        SparseMatrix( 1, 6, [ [ 2, 3, 4, 5, 6 ] ], [ [ 1/128, 1/128, -1/128, -1/128, 1 ] ] ), 
                        SparseMatrix( 2, 6, [ [ 4, 5 ], [ 2, 3 ] ], [ [ -1, 1 ], [ -1, 1 ] ] ) ], 
                        [ false, false, false ], [ false, false, false ], [ false, false, false ], [ false, false, false ] ],
        group := g,
        innerproducts := [ 1, 3/128, 3/128, 0, 875/524288 ],
        involutions := [ g.1, g.2, g.1*g.2*g.1, g.1*g.2*g.1*g.2*g.1, g.2*g.1*g.2 ],
        nullspace := SparseMatrix( 0, 6, [  ], [  ] ),
        setup := rec(   conjelts := [ [ 1 .. 6 ], [ 2, 5, 1, 3, 4, 6 ], [ 3, 4, 1, 2, 5, 6 ], [ 4, 3, 5, 2, 1, 6 ], [ 5, 2, 4, 3, 1, 6 ] ],
                        coords := [ g.1, g.2, g.1*g.2*g.1, g.1*g.2*g.1*g.2*g.1, g.2*g.1*g.2, g.1*g.2 ],
                        longcoords := [ g.1, g.2, g.1*g.2*g.1, g.1*g.2*g.1*g.2*g.1, g.2*g.1*g.2, g.1*g.2, (g.1*g.2)^2, (g.2*g.1)^2, g.2*g.1 ],
                        orbitreps := [ 1 ],
...
rec(    algebraproducts := [    SparseMatrix( 1, 8, [ [ 1 ] ], [ [ 1 ] ] ), 
        ...
        setup := rec(   conjelts := [ [ 1 .. 8 ], [ 1, 3, 2, 4, 6, 5, 7, 8 ], [ 5, 4, 2, 3, 6, 1, 7, 8 ], [ 5, 2, 4, 3, 1, 6, 7, 8 ], [ 6, 3, 4, 2, 1, 5, 7, 8 ] ],
                        coords := [ g.1, g.2, g.1*g.2*g.1, g.2*g.1*g.2*g.1*g.2, g.2*g.1*g.2, g.1*g.2*g.1*g.2*g.1, (g.1*g.2)^3, (g.1*g.2)^2 ],
                        longcoords := [ g.1, g.2, g.1*g.2*g.1, g.2*g.1*g.2*g.1*g.2, g.2*g.1*g.2, g.1*g.2*g.1*g.2*g.1, (g.1*g.2)^3, (g.1*g.2)^2, (g.2*g.1)^2 ],
                        orbitreps := [ 1, 2, 7 ],
